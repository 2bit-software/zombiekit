...
<!--
  ...
  Test Comment Style:
  - Test comments and section headers in code MUST use short business-language
    descriptions of what the scenario verifies — NOT spec/requirement IDs.
  - Good:  "// Importing the same file twice skips already-stored messages"
  - Good:  "// New version of a memory soft-deletes the previous version"
  - Bad:   "// BR-002 (No duplicates)"
  - Bad:   "// T018 [P] [US2]"
  - Bad:   "// FR-013: needs-attention should be applied"
